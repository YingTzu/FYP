...
Suspects.Game5.prototype = 
{
    create: function()
    {
        ...
        this.timeManager.createTimerDown(this.world.width*0.775, this.world.height*0.23, 40);
        
        this.glowing = this.add.sprite(this.world.width*0.385, this.world.height*0.82, 'Glowing');
        this.glowing.anchor.set(0.5,0.5);
        this.glowing.scale.setTo(0.33,0.41);
        ...
        this.guiltyFace = this.add.sprite(this.world.width*0.5, this.world.height*0.7, 'Lv5Suspect_2');
    ...
    { 
        this.suspectGroup.forEach(function(suspects)
        {
            ...
            {   
                ...
                {
                    this.wrongSuspect();
                    this.renderWrong(this.world.width*0.22, this.world.height*0.4);
                }
                ...
                {
                    this.wrongSuspect();
                    this.renderWrong(this.world.width*0.56, this.world.height*0.4);
                }
                if(suspects.name == "person15")
                {
                    this.wrongSuspect();
                    this.renderWrong(this.world.width*0.7, this.world.height*0.43);
                }
