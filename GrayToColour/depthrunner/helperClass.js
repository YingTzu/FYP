...
// use this function to add a multiplier to anything that we wish to scale according to the environment's atmospheric depth
function LayerScalingFactor(layer)
{
    if(layer == 0)
    {
        return 0.25;
